...
public class SetPractice2 {
    ...
    public static void main(String[] args) {
        ...
        //arr = new HashSet<>(Arrays.asList(arr)).toArray(new String[0]);//[Paper towels, Wooden Spoon, Coke, Eggs, Book, Phone, Pen, Milk]
        arr = new LinkedHashSet<>(Arrays.asList(arr)).toArray(new String[0]);//[Wooden Spoon, Book, Pen, Phone, Milk, Eggs, Coke, Paper towels]

        /*
        Set<String> set1 = new HashSet<>(Arrays.asList(arr));//[Paper towels, Wooden Spoon, Coke, Eggs, Book, Phone, Pen, Milk]
